import { upsertStremaUser } from "../../config/stream.js";
...
export const login = async (req, res) => {
    try {
        ...
        const isPasswordConnect = await user.matchPassword(password);
        if(!isPasswordConnect) return res.status(401).json({ message: "Invalid password"});
